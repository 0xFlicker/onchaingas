...
export interface IDataChunkCompilerInterface extends utils.Interface {
  functions: {
...
export interface IDataChunkCompiler extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IDataChunkCompilerInterface;
