...
export interface FFlateDataChunk2Interface extends utils.Interface {
  functions: {
...
export interface FFlateDataChunk2 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FFlateDataChunk2Interface;
