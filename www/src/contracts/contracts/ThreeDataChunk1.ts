...
export interface ThreeDataChunk1Interface extends utils.Interface {
  functions: {
...
export interface ThreeDataChunk1 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ThreeDataChunk1Interface;
