...
export interface ThreeDataChunk2Interface extends utils.Interface {
  functions: {
...
export interface ThreeDataChunk2 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ThreeDataChunk2Interface;
