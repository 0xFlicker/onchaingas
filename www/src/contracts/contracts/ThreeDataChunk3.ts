...
export interface ThreeDataChunk3Interface extends utils.Interface {
  functions: {
...
export interface ThreeDataChunk3 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ThreeDataChunk3Interface;
