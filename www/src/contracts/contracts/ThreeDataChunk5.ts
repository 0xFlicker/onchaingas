...
export interface ThreeDataChunk5Interface extends utils.Interface {
  functions: {
...
export interface ThreeDataChunk5 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ThreeDataChunk5Interface;
