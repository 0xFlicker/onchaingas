...
export interface ThreeDataChunk6Interface extends utils.Interface {
  functions: {
...
export interface ThreeDataChunk6 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ThreeDataChunk6Interface;
