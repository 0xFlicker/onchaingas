...
export interface ThreeDataChunk7Interface extends utils.Interface {
  functions: {
...
export interface ThreeDataChunk7 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ThreeDataChunk7Interface;
