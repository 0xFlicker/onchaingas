...
export interface ThreeDataChunk8Interface extends utils.Interface {
  functions: {
...
export interface ThreeDataChunk8 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ThreeDataChunk8Interface;
