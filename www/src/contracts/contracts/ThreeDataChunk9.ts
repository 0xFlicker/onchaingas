...
export interface ThreeDataChunk9Interface extends utils.Interface {
  functions: {
...
export interface ThreeDataChunk9 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ThreeDataChunk9Interface;
